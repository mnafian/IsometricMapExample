...
public class TMXLoader {
     ...
     *
     * @param pValue {@link Boolean} <code>true</code> to use a
     ...
     * @param pMapOriginX  {@link Float} of map origin X. Basically, from where should
     *                     the first tile draw location be on X axis. (Isometric support
     *                     only)
     * @param pMapOriginY  {@link Float} of map origin Y. Basically, from where should
