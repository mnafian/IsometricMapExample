...
public class TMXTileSet implements TMXConstants {
     ...
     *
     * @param pAttributes              {@link Attributes} from XML.
     * @param pTextureOptions          {@link TextureOptions} to use
     * @param pTMXTileSetSourceManager {@link TMXTileSetSourceManager} to use. Can pass
     ...
     * Create a new {@link TMXTileSet}
     *
     * @param pFirstGlobalTileID       {@link Integer} of the first global tile id.
     * @param pAttributes              {@link Attributes} from XML.
     * @param pTextureOptions          {@link TextureOptions} to use
     * @param pTMXTileSetSourceManager {@link TMXTileSetSourceManager} to use. Can pass
     *                                 <code>null</code> if you don't want to use one.
     ...
     *
     * @param pTMXTileSet {@link TMXTileSet} to copy
     */
