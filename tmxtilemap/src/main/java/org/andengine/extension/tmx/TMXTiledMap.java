...
public class TMXTiledMap implements TMXConstants {
     ...
     *
     * @param pTMXTiledMap      {@link TMXTiledMap} to copy
     * @param pDeepCopyTextures {@link Boolean} Should we attempted to copy textures? <b>In some areas this is not possible</b>
     * @throws Exception
     */
     ...
     *
     * @param pValue {@link Boolean} <code>true</code> using a
     *               {@link LowMemorySpriteBatchVertexBufferObject} or
     ...
     *
     * @param pValue <code>true</code> to allocate, <code>false</code> to not
     *               allocate.
     */
     ...
     *
     * @param pStoreGID {@link Boolean} <code>true</code> to store, <code>false</code>
     *                  not to store
     */
