...
public interface ITouchManager {
     ...
     *
     * @param pBaseEntity      {@link BaseEntity} clicked
     ...
     *
     * @param pTouchListener {@link ITouchListener} to pass the touch event to.
     */
     ...
     * passed through
     *
     * @param pTouchListener {@link ITouchListener} to stop getting the touch event pass
     *                       through
     */
