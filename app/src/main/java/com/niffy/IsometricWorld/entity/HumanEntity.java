...
public class HumanEntity implements IHumanEntity, ITouchAreaListener, IIsometricEntity3DSpaceRecalculation {
    ...
    /**
     * @param pAnimatedSprite     {@link AnimatedSprite} of human.
     * @param pRows               {@link Integer} Amount of rows in sprite sheet for
     *                            {@link AnimatedSprite}
     * @param pColumns            {@link Integer} Amount of columns in sprite sheet for
     *                            {@link AnimatedSprite}
     * @param pOffset             {@link Float} of offset for sprite, can be 0,0. [0] X [1] Y
     * @param pDurationTileToTile {@link Float} Duration of going from the centre of one tile to
     *                            the next.
     * @param mAnimatedTileSpeed  {@link Long} Duration of each frame in animated sprite.
     */
     ...
     * @param pDurationTileToTile {@link Float} Duration of going from the centre of one tile to
     *                            the next.
     * @param mAnimatedTileSpeed  {@link Long} Array Duration of each frame in animated sprite.
     */
    public HumanEntity(final AnimatedSprite pAnimatedSprite, final int pRows, final int pColumns,
                       final float[] pOffset, final float pDurationTileToTile, final long[] pAnimatedTileSpeed,
                       final MapHandler pMapManager) {
